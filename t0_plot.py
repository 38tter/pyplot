...
data_wire, data_t0, data_t0err= np.loadtxt("t0_temp3.dat", comments="!", unpack=True)
...
x = np.arange(0, 272, 0.01)
para_ini = [ -3800, 0, 1 ]
#param, cov = curve_fit(fitfunc, data_wire, data_t0, para_ini)
#y = param[0] + param[1]*x + param[2]*x*x

data_wire2, data_t02, data_t0err2= np.loadtxt("t0_a_temp3.dat", comments="!", unpack=True)
...
plt.xlabel("Fw")
plt.ylabel("p0")
plt.savefig("pdf/num_vs_t0_pro_18a.pdf")
